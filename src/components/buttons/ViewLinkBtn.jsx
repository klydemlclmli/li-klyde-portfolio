...
export default function ViewLinkBtn(props) {
  return (
    <button onClick={() => window.open(props.link, '_blank')} className='drop-shadow-btn-shadow font-syne text-[14px] text-black font-bold bg-white px-[20px] py-[10px] rounded-[99px]
