...
export default function Designs(props) {
  ...
  return (
    <div id={props.sectionIds.designs} className='base py-[60px] 2xl:py-[100px] 2xl:pb-[170px] md:pb-[90px] px-5 md:px-10 2xl:px-[130px] font-syne text-black font-bold text-[14px] gap-14 2xl:gap-[100px]'>
      ...
      <div className='base w-full md:gap-[90px] xl:gap-[120px] 2xl:gap-[170px]'>
        ...
        <Link ref={props.tuklaspital} to='/designs/Tuklaspital' className='flex flex-col md:self-start md:flex-row md:gap-5 drop-shadow-blk-shadow md:drop-shadow-none'>
